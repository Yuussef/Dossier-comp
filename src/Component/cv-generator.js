...
export class DocumentCreator {
            ...
            sections: [

                {
                    children: [
                        ...
                        new Paragraph("Dr. Dean Mohamedally Director of Postgraduate Studies Department of Computer Science, University College London Malet Place, Bloomsbury, London WC1E d.mohamedally@ucl.ac.uk"),
    ...
    createHeading(text) {
        return new Paragraph({
            ...
            thematicBreak: true,alignment: AlignmentType.CENTER,
            style: {
                size: 32, // Customize the font size for the numbering part
                font: "Times New Roman", // Customize the font for the numbering part
                text : {
                    size: 32, // Customize the font size for the numbering part
